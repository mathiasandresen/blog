...
<nav
	...
	bg-gray-50 bg-opacity-60 py-8 text-gray-900 dark:border-gray-700 dark:bg-background-color
	dark:text-gray-100 sm:pb-16"
>
	<!-- <a href="#skip" class="skip-nav">Skip to content</a> //TODO: Put this in again in some way -->
	<MobileMenu />
