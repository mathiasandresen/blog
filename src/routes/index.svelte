	...
	<div class="flex flex-col-reverse items-start sm:flex-row">
		<div class="flex flex-col pr-8">
			<h1 class="mb-3 text-3xl font-bold tracking-tight text-black dark:text-white md:text-5xl">
				Hello, i'm
				<span
					class="relative ml-2 inline-block before:absolute before:-inset-1 before:block before:-skew-y-3 before:bg-gradient-to-r before:from-primary before:via-secondary before:to-tertiary"
				>
					<span class="relative skew-y-3 text-white">Mathias</span>
				</span>
				!
			</h1>
			<h2 class="mb-4 text-gray-700 dark:text-gray-200">
				I'm studying Software Engineering at Aalborg University in Denmark, and i'm a student
				developer at <a class="text-primary" href="https://wexo.dk">WEXO A/S.</a>
			</h2>
			<p class="text-gray-700 dark:text-gray-200 mb-4">
				My interests includes
				<span class="text-tertiary">software development</span>,
				<span class="text-tertiary">football (soccer)</span>,
				<span class="text-tertiary">gaming</span>,
				<span class="text-tertiary"> home automation</span>, and
				<span class="text-tertiary">roundnet/spikeball</span>.
			</p>
		</div>
		<img
			src="/images/profile.jpg"
			alt="Mathias Andresen"
