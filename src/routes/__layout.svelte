...
<div class="flex flex-col justify-center bg-gray-50 px-4 dark:bg-background-color sm:px-8">
	<Nav />
</div>
<main class="flex flex-col justify-center bg-gray-50 px-4 dark:bg-background-color sm:px-8">
	<slot />
</main>
